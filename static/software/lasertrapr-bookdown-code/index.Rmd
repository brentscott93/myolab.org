...
You can download and older "stable" version from 2022 from my *drat* repository on Github with the following code. Copy/paste the following into the R-Console or into an R-Script to run:  
```{r eval=FALSE}
